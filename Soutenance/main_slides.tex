...
\begin{itemize}
  ...
  \item Search for a single produced \Tp~decaying into top and Higgs in the full hadronic final state
    \begin{itemize}\scriptsize
    \item \textcolor{red}{Difficult and original channel} $\to$ A selection to extract signal and a reconstruction procedure to find the \Tp~decay products
...
\begin{column}{.50\textwidth}
\begin{center}
    \includegraphics[width=1.0\textwidth]{Limits_from_CLs_Perspectives_8TeV30invfb_SO.png}\\
  \end{center}
\end{column}
