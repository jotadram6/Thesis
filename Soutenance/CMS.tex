...
\begin{frame}{}
\tikz[remember picture,overlay]{\node (b) at (0.5\paperwidth,0.0\paperheight) [inner sep=0pt,opacity=0.4]{
\includegraphics[width=1.2\paperwidth]{PatriclesTraces.jpg}};}
%
%\tikz[remember picture,overlay]
%    \node (b) at
%      (current page.center) [inner sep=0pt,opacity=.4]
%      {\begin{overpic}[height=.9\paperheight]{PatriclesTraces.jpg}\end{overpic}};
