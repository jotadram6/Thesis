...
\begin{tabular}{|c|c|c|}
\hline 
\Tp~Mass & Single production $\sigma$ & Pair production $\sigma$ \\
\hline
400 & 635.7 & 992.5 \\
450 & 452.6 & 483.5 \\
500 & 347.5 & 263.8 \\
...
\caption{\Tp~production cross sections in single and pair production modes, for proton-proton collisions at 8 TeV.\label{tab:TheoXS}}
\end{center}
\end{table*}
